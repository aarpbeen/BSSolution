      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        >
          ...
          <div className="lg:w-1/2 space-y-6 mt-8 lg:mt-0 lg:pl-12">
            ...
            <p
              ...
              data-aos="fade-right"
            >
              Established in [Year], we specialize in delivering world-class
              financial consulting and educational services. Our mission is
              centered around innovation, quality, and unparalleled customer
              satisfaction.
            </p>
            <p className="text-lg text-gray-600 dark:text-gray-300">
              We provide expert financial consulting, in-depth research, and
              high-quality training to meet the demands of our diverse
              clientele.
            </p>
          </div>
        </section>
        ...
        >
          <div className="lg:w-1/2 flex flex-col items-start space-y-6 lg:pr-8">
            ...
            <p className="text-lg italic text-gray-600 dark:text-gray-300">
              At [Company Name], we empower our clients through top-notch
              services. Our commitment to excellence drives us to innovate and
              adapt to the ever-changing market landscape.
            </p>
            <p className="text-lg font-semibold text-gray-600 dark:text-gray-300">
              — Bishnu Prasad Khanal, CEO
            </p>
          </div>
        ...
        <section id="partners" className="text-center" data-aos="fade-right">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
            We work with leading organizations to enhance our service offerings
            globally.
          </p>
            ...
            {[1, 2, 3, 4].map((partner) => (
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Description for Partner {partner}
                </p>
              </div>
            ))}
          </div>
            ...
            {[2020, 2021, 2022].map((year, index) => (
              ...
              >
                ...
                <p className="text-gray-500 dark:text-gray-400 pl-12">
                  {year === 2020
                    ? 'Our company was founded with a vision to innovate and lead in the industry.'
                    : year === 2021
                    ? 'Achieved our first major milestone, launching our flagship product.'
                    : 'Expanded our services to new markets and enhanced our offerings.'}
                </p>
              </div>
            ))}
          </div>
