...
const testimonials = [
  {
    ...
    feedback: 'B.S. Global provided exceptional research insights that helped us make informed decisions on our strategic financial moves. Their expertise is unmatched!',
    image: '/images/testimonial-sarah.jpg',
  },
  {
    name: 'James Smith',
    position: 'Head of Business Strategy, FutureCorp',
    feedback: 'The consultancy services offered by B.S. Global have transformed our approach to business. Their deep knowledge of market trends helped us refine our strategy.',
    image: '/images/testimonial-james.jpg',
  },
  {
    name: 'Alicia Brown',
    position: 'Founder, Global Markets Inc.',
    feedback: 'Their education and certification programs are top-notch. We were able to upskill our employees and achieve greater results thanks to their courses.',
  ...
  return (
    <section className="bg-gray-100 py-5 font-Josefin dark:bg-gray-900">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl font-semibold text-gray-800 dark:text-gray-100 text-left underline"
